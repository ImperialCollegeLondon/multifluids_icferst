...
module halos_numbering
  ...
  interface get_universal_numbering_baij
    module procedure get_universal_numbering_baij, get_universal_numbering_multiple_components_baij
  end interface
...
contains
  ...
  subroutine get_universal_numbering_baij(halo, unns)
    ...
    select case(halo_ordering_scheme(halo))
      ...
      case(HALO_ORDER_TRAILING_RECEIVES)
        call get_universal_numbering_order_trailing_receives_baij(halo, unns)
      case default
        FLAbort("Unrecognised halo ordering scheme")
    end select
  ...
  subroutine get_universal_numbering_multiple_components_baij(halo, unns)
    ...
    select case(halo_ordering_scheme(halo))
      case(HALO_ORDER_GENERAL)
        call get_unn_multiple_components_order_general_baij(halo, unns)
      case(HALO_ORDER_TRAILING_RECEIVES)
        call get_unn_multiple_components_order_trailing_receives_baij(halo, unns)
      case default
        FLAbort("Unrecognised halo ordering scheme")
    end select
  ...
  end subroutine get_unn_multiple_components_order_trailing_receives_baij
