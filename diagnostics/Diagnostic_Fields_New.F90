...
contains
  ...
  subroutine calculate_diagnostic_variable_scalar_multiple_indexed(states, state_index, s_field, algorithm, stat)
    ...
    select case(trim(lalgorithm))
      ...
      case("mesh_quality")
        call calculate_mesh_quality(state, s_field)
      ...
      case("subtract_average")
        call calculate_subtract_average(state, s_field)
      case("subtract_point_value")
        call calculate_subtract_point_value(state, s_field)
      case("subtract_surface_average")
        call calculate_subtract_surface_average(state, s_field)
      case("scalar_copy")
