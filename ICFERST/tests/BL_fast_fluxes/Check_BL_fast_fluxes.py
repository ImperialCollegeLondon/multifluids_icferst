...
with open("QuickTest_DG_outfluxes.csv") as f1:
...
with open("outfluxes_Control.csv") as f2:
    f2.readline()
    for row in f2:
        columns = row.split(",")
        try:
...
if abs(totalMass - InjectedMass) < toleranceMass:
    ...
    if (
        L1_sum1 < tolerance1
        and L1_sum2 < tolerance1
        and L1_sum3 < tolerance1
        and L1_sum4 < tolerance1
        and L1_sum5 < tolerance2
        and L1_sum6 < tolerance2
        and L1_sum7 < tolerance2
        and L1_sum8 < tolerance2
    ):
