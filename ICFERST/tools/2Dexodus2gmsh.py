...
def write_in_ASCII_format(fname):
    ...
    #print('ele_face_dict', ele_face_dict)
    #print('ele_vol_dict', ele_vol_dict)
    for k,ele in enumerate(ele_face_dict):
    ...
    for k,ele in enumerate(ele_vol_dict):
        ...
        file.write("%d 2 2 %d %d %d %d %d\n"%(k+1+len(ele_face_dict),ele[0],ele[0],ele[1],ele[2],ele[3]))
...
#print('GetNumberOfBlocks 4: ', data.GetBlock(4).GetNumberOfBlocks())
#print('GetNumberOfBlocks 3: ', data.GetBlock(3).GetNumberOfBlocks())
#print('GetNumberOfBlocks 2: ', data.GetBlock(2).GetNumberOfBlocks())
print('GetNumberOfBlocks 5: ', data.GetBlock(5).GetNumberOfBlocks())
print('GetNumberOfBlocks 0: ', data.GetBlock(0).GetNumberOfBlocks())
...
for j in range(data.GetBlock(0).GetNumberOfBlocks()):
    ...
    print('npoints, ncells: ', ug.GetNumberOfPoints(), ug.GetNumberOfCells())
    #print('')
