...
# --------------------------------------------------------------------------------------------------------------------
def compare_two_files_dump_seris(
    file_series_name1,
    file_series_name2,
    dump_start,
    dump_end,
    ...
    for dump_num in range(0, dump_difference + 1):
        ...
        filein_1 = open(file_series_name3 + ".d." + str(dump_num + 1))
        filein_2 = open(file_series_name4 + ".d." + str(dump_num + 1))
        ...
        if number_lines_1 == number_lines_2:
            ...
            number_lines = 0
            print(
                "Error, two files have different number of lines",
                number_lines_1,
                number_lines_2,
            )
    ...
    print(
        "Relative tolerance, Max relative difference over all dumps and associated dump number",
        rel_tolerance,
        maxdiff_alldump,
        maxdiff_dumpnum,
    )
    print(
        "Finish Compare two file dump series: pass_number(1=pass,0=fail)", pass_number
    )
...
def compare_two_files(
    file_name1, file_name2, rel_tolerance, start1, end1, start2, end2
):
    ...
    filein_1 = open(file_name3)
    filein_2 = open(file_name4)
