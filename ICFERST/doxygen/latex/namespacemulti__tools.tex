...
\item 
type \mbox{\hyperlink{structmulti__tools_1_1bad__elements}{bad\+\_\+elements}}
\begin{DoxyCompactList}\small\item\em \+: Type to keep an eye on the quality of the elements @\+D\+E\+P\+R\+E\+C\+A\+T\+ED \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\footnotesize\ttfamily subroutine multi\+\_\+tools\+::least\+\_\+squares\+\_\+solver (\begin{DoxyParamCaption}\item[{real, dimension(3$\ast$size(a,1)+1), intent(inout)}]{A,  }\item[{real, dimension(\+:,\+:), intent(inout)}]{b,  }\item[{integer, intent(inout)}]{rank }\end{DoxyParamCaption})}
