...
\begin{DoxyCompactList}\small\item\em Calls to generate and solve the transport equation for n passive tracers defined in diamond as Passive\+\_\+\+Tracer\+\_\+N Where N is an integer which is continuous starting from 1. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Calls to generate the Gradient Matrix, the divergence matrix, the momentum matrix and the mass matrix Once these matrices (and corresponding R\+H\+Ss) are generated the system of equations is solved using the projection method. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$ This subroutine calculates a tensor of viscocity L\+E\+S\+\_\+\+U\+D\+I\+F\+F\+U\+S\+I\+ON, L\+E\+S\+\_\+\+U\+D\+I\+F\+F\+U\+S\+I\+O\+N\+\_\+\+V\+OL \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$This subroutine combines the distributed and block diagonal for an element into the matrix D\+G\+M\+\_\+\+P\+HA. For stokes also the diagonal of the matrix is introduced in the mass matrix \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$This subroutine combines the distributed and block diagonal for an element into the matrix D\+G\+M\+\_\+\+P\+HA. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Used to assemble the C matrix in the I\+C\+F\+E\+R\+ST format. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Used to assemble the C matrix in the I\+C\+F\+E\+R\+ST format (for DG?) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$ This sub will linearise a p2 field \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: This subroutine performs and introduces the gradient of a R\+HS field (Capillary pressure for example) for the momentum equation. It has two options (hard-\/coded) integrations by parts (activated) or voluemtric integration, For capillary pressure\+: The capillary pressure is a term introduced as a R\+HS which affects the effective velocity \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \+: $<$\+I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$Determine if we have an oscillation in the normal direction... dg\+\_\+oscilat\+\_\+detect=1.\+0-\/ C\+E\+N\+T\+R\+AL S\+C\+H\+E\+ME. dg\+\_\+oscilat\+\_\+detect=0.\+0-\/ U\+P\+W\+I\+ND S\+C\+H\+E\+ME. \end{DoxyCompactList}\item 
...
\+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$This subroutine combines the distributed and block diagonal for an element into the matrix D\+G\+M\+\_\+\+P\+HA. For stokes also the diagonal of the matrix is introduced in the mass matrix 
...
\+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$This subroutine combines the distributed and block diagonal for an element into the matrix D\+G\+M\+\_\+\+P\+HA. 
...
\hline
{\em multicomponent\+\_\+state} & Linked list containing all the fields used by compositional, just in case we are solving for components $>$\\
\hline
...
\hline
{\em G\+E\+T\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,U\+S\+E\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX} & ????? \\
\hline
{\em T\+H\+E\+T\+A\+\_\+\+G\+D\+I\+FF} & ???? \\
\hline
{\em eles\+\_\+with\+\_\+pipe} & Elements that have a pipe \\
\hline
{\em pipes\+\_\+aux} & Information required to define wells \\
\hline
{\em mass\+\_\+ele} & Mass of the elements \\
\hline
{\em sum\+\_\+theta\+\_\+flux,sum\+\_\+one\+\_\+m\+\_\+theta\+\_\+flux,sum\+\_\+theta\+\_\+flux\+\_\+j,sum\+\_\+one\+\_\+m\+\_\+theta\+\_\+flux\+\_\+j} & ???? \\
\hline
\end{DoxyParams}
...
\+: $<$\+I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$Determine if we have an oscillation in the normal direction... dg\+\_\+oscilat\+\_\+detect=1.\+0-\/ C\+E\+N\+T\+R\+AL S\+C\+H\+E\+ME. dg\+\_\+oscilat\+\_\+detect=0.\+0-\/ U\+P\+W\+I\+ND S\+C\+H\+E\+ME. 
...
\+: $<$\+I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$ This sub calculates the effective diffusion coefficientd D\+I\+F\+F\+\_\+\+C\+O\+E\+F\+\_\+\+D\+I\+V\+DX,D\+I\+F\+F\+\_\+\+C\+O\+E\+F\+O\+L\+D\+\_\+\+D\+I\+V\+DX based on a non-\/linear method and a non-\/oscillating scheme. This implements the stress and tensor form of diffusion and calculates a jump conidition. which is in D\+I\+F\+F\+\_\+\+C\+O\+E\+F\+\_\+\+D\+I\+V\+DX, D\+I\+F\+F\+\_\+\+C\+O\+E\+F\+O\+L\+D\+\_\+\+D\+I\+V\+DX The coefficient are in N\+\_\+\+D\+O\+T\+\_\+\+D\+K\+DU, N\+\_\+\+D\+O\+T\+\_\+\+D\+K\+D\+U\+O\+LD. look at the manual DG treatment of viscocity. 
...
{\em pipes\+\_\+aux} & Information required to define wells \\
\hline
{\em option\+\_\+path} & Option path of the tracer to be solved for \\
\hline
{\em mass\+\_\+ele\+\_\+transp} & Mass of the elements \\
\hline
{\em T\+H\+E\+R\+M\+AL} & If true then we are solving for temperature \\
\hline
{\em T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J} & ???? \\
\hline
{\em icomp} & Number of components, if $>$ 0 then compositional is solved \\
\hline
{\em saturation} & Phase\+Volume\+Fraction field \\
\hline
{\em Permeability\+\_\+tensor\+\_\+field} & Permeability field param nonlinear\+\_\+iteration Current non-\/linear iteration \\
\hline
{\em magma\+\_\+phase\+\_\+coefficients} & Structure containing the information to solve for magma \\
\hline
\end{DoxyParams}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
Calls to generate the Gradient Matrix, the divergence matrix, the momentum matrix and the mass matrix Once these matrices (and corresponding R\+H\+Ss) are generated the system of equations is solved using the projection method. 
...
{\em pipes\+\_\+aux} & Information required to define wells \\
\hline
{\em velocity} & tensor field. Why do we pass it down instead of retrieving it from packed\+\_\+state... \\
\hline
{\em pressure} & tensor field\+Why do we pass it down instead of retrieving it from packed\+\_\+state... \\
\hline
{\em DT} & Time step size \\
\hline
{\em S\+U\+F\+\_\+\+S\+I\+G\+\_\+\+D\+I\+A\+G\+T\+E\+N\+\_\+\+BC} & Like upwnd but for the boundary \\
\hline
{\em V\+\_\+\+S\+O\+U\+R\+CE} & Source term \\
\hline
{\em V\+O\+L\+F\+R\+A\+\_\+\+P\+O\+RE} & Porosity field (Mdimsnpres,Mdimstotele) \\
\hline
{\em I\+G\+O\+T\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J} & ???? \\
\hline
{\em calculate\+\_\+mass\+\_\+delta} & This is to compute mass conservation \\
\hline
{\em outfluxes} & variable containing the outfluxes information \\
\hline
{\em pres\+\_\+its\+\_\+taken} & Integer containing the number of iterations performed by the solver to solve for pressure \\
\hline
{\em nonlinear\+\_\+its} & current non-\/linear iteration \\
\hline
{\em Courant\+\_\+number} & Global courant number and shock front courant number \\
\hline
\end{DoxyParams}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\hline
{\em field\+\_\+name} & name of the field to be solved for \\
\hline
...
\hline
{\em solver\+\_\+path} & Path to select the type of solver \\
\hline
\end{DoxyParams}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
{\em ndgln} & Global to local variables \\
\hline
{\em Overrelaxation} & I\+N\+O\+UT Field containing the outcome of this subroutine \\
\hline
{\em Phase\+\_\+with\+\_\+\+Pc} & Phase that will contain the Overrelaxation field \\
\hline
{\em totally\+\_\+min\+\_\+max} & Min max of the field (to normalise for transport) \\
\hline
{\em for\+\_\+transport} & True if the field is not saturation \\
\hline
\end{DoxyParams}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
{\em ndgln} & Global to local variables \\
\hline
{\em u\+\_\+rhs} & I\+N\+O\+UT Field to contain the outcome of this subroutine \\
\hline
{\em state} & Linked list containing all the fields defined in diamond and considered by Fluidity \\
\hline
{\em packed\+\_\+state} & Linked list containing all the fields used by I\+C-\/\+F\+E\+R\+ST, memory partially shared with state \\
...
{\em Number} & of phases \\
\hline
{\em u\+\_\+absorbin} & Absorption associated to the momentum equation/velocity \\
\hline
\end{DoxyParams}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
{\em ndgln} & Global to local variables \\
\hline
{\em C\+M\+C\+\_\+petsc} & petsc\+\_\+csr\+\_\+matrix field containing the pressure matrix. Matrix to be modified here \\
\hline
{\em rhs\+\_\+p} & R\+HS associated to the pressure matrix. \\
\hline
\end{DoxyParams}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\hline
{\em icomp} & Number of components, if $>$ 0 then compositional is solved param nonlinear\+\_\+iteration Current non-\/linear iteration \\
\hline
\end{DoxyParams}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\+: This subroutine performs and introduces the gradient of a R\+HS field (Capillary pressure for example) for the momentum equation. It has two options (hard-\/coded) integrations by parts (activated) or voluemtric integration, For capillary pressure\+: The capillary pressure is a term introduced as a R\+HS which affects the effective velocity 
...
{\em Mmat} & Matrices for I\+C\+F\+E\+R\+ST \\
\hline
{\em R\+H\+S\+\_\+field} & The values to introduce, for capilalry pressure these are the evaluted values of Cap\+Pressureval \\
\hline
{\em F\+E\+\_\+funs} & Shape functions for the FE mesh \\
\hline
{\em Devfuns} & Derivatives of the F\+E\+\_\+funs \\
\hline
{\em X\+\_\+\+A\+LL} & Coordinates of the nodes \\
\hline
{\em L\+O\+C\+\_\+\+U\+\_\+\+R\+HS} & R\+HS I\+N\+O\+UT field with the updated field \\
\hline
{\em ele} & Current element \\
\hline
{\em cv\+\_\+ndgln} & Global to local variables of the CV mesh \\
\hline
{\em x\+\_\+ndgln} & Global to local variables of the nodes \\
\hline
{\em ele2} & neighbouring element \\
\hline
{\em iface} & current face being integrated \\
\hline
{\em sdetwe} & edge lenght associated to the current gauss integration point, i.\+e. edge lenght \\
\hline
{\em S\+N\+O\+R\+M\+X\+N\+\_\+\+A\+LL} & normal to the current surface \\
\hline
{\em U\+\_\+\+S\+L\+O\+C2\+L\+OC} & Surface local to local for velocity nodes \\
\hline
{\em C\+V\+\_\+\+S\+L\+O\+C2\+L\+OC} & Surface local to local for cv nodes \\
\hline
{\em M\+A\+T\+\_\+\+O\+T\+H\+E\+R\+\_\+\+L\+OC} & for sub-\/\+CV the neighbouring one \\
\hline
\end{DoxyParams}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$ This sub will linearise a p2 field 
...
Calls to generate and solve the transport equation for n passive tracers defined in diamond as Passive\+\_\+\+Tracer\+\_\+N Where N is an integer which is continuous starting from 1. 
...
Used to assemble the C matrix in the I\+C\+F\+E\+R\+ST format. 
...
Used to assemble the C matrix in the I\+C\+F\+E\+R\+ST format (for DG?) 
...
\+: $<$\+F\+O\+R I\+N\+E\+R\+T\+I\+A O\+N\+L\+Y$>$ This subroutine calculates a tensor of viscocity L\+E\+S\+\_\+\+U\+D\+I\+F\+F\+U\+S\+I\+ON, L\+E\+S\+\_\+\+U\+D\+I\+F\+F\+U\+S\+I\+O\+N\+\_\+\+V\+OL 
...
\hline
{\em time\+\_\+step} & current time-\/step \\
\hline
{\em S\+F\+P\+I\+\_\+its} & Number of saturation fixed point iterations taken \\
\hline
{\em Courant\+\_\+number} & Global courant number and shock front courant number \\
\hline
{\em T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+UX,T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J,O\+N\+E\+\_\+\+M\+\_\+\+T\+H\+E\+T\+A\+\_\+\+F\+L\+U\+X\+\_\+J} & ???? \\
