...
This subroutine calculates the global node numbers requested to operates in the M\+P-\/space. 
...
\+: This subroutine calculates the actual Darcy velocity, but with P0\+DG precision 
...
@\+D\+E\+P\+R\+E\+C\+A\+T\+ED\+: Gets memory from packed state 
...
\+: Sets the boundary condition, if the time has advance and the B\+Cs changed, here they are set to the new time-\/level 
