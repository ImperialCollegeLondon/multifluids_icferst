  ...
  subroutine allocate_and_insert_fields(states, dont_allocate_prognostic_value_spaces)
    ...
    if (have_option('/porous_media')) then
       ...
       !Insert if required thermal porous media fields
        ...
        !HH
        if (is_magma .and. have_option('/material_phase::Solid/scalar_field::Composition')) then
          call allocate_and_insert_scalar_field('/material_phase::Solid/scalar_field::Composition', &
