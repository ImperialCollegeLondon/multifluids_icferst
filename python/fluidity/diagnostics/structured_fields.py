...
class StructuredField2D:
    ...
    def _NewData(self):
        if self._shape is None:
            self._data = [
                [None for i in range(self.YCoordsCount())]
    ...
    def LinearlyInterpolate(self, x, y):
        ...
        return calc.BilinearlyInterpolate(
            self.GetVal(left, upper),
            self.GetVal(right, upper),
            self.GetVal(left, lower),
            self.GetVal(right, lower),
    ...
    def ToVtu(self, axis=(0.0, 1.0, 0.0), quadMesh=False):
        ...
        if (
            not calc.AlmostEquals(axis[0], 0.0)
...
class structured_fieldsUnittests(unittest.TestCase):
    def testStructuredField2D(self):
        ...
        self.assertAlmostEqual(field.LinearlyInterpolate(0.5, 0.0), 0.5)
        self.assertAlmostEqual(field.LinearlyInterpolate(0.0, 0.5), 1.0)
        self.assertAlmostEqual(field.LinearlyInterpolate(0.5, 0.5), 1.5)
    ...
    def testVtuInteroperability(self):
        ...
        self.assertAlmostEqual(locations[0][0], 0.0)
        self.assertAlmostEqual(locations[0][1], 0.0)
        self.assertAlmostEqual(locations[0][2], 0.0)
        self.assertAlmostEqual(locations[1][0], 1.0)
        self.assertAlmostEqual(locations[1][1], 0.0)
        self.assertAlmostEqual(locations[1][2], 0.0)
        self.assertAlmostEqual(locations[2][0], 0.0)
        self.assertAlmostEqual(locations[2][1], 1.0)
        self.assertAlmostEqual(locations[2][2], 0.0)
        self.assertAlmostEqual(locations[3][0], 1.0)
        self.assertAlmostEqual(locations[3][1], 1.0)
        self.assertAlmostEqual(locations[3][2], 0.0)
        self.assertAlmostEqual(data[0], 0.0)
        self.assertAlmostEqual(data[1], 1.0)
        self.assertAlmostEqual(data[2], 2.0)
        self.assertAlmostEqual(data[3], 3.0)
