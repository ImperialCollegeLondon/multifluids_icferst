...
class boundsUnittests(unittest.TestCase):
    def testBoundingBox(self):
        ...
        self.assertEqual(bounds.Dim(), 3)
        self.assertEqual(bounds.UsedDim(), 0)
        bounds.SetUbound((0.0, 1.1, 2.0))
        self.assertEqual(bounds.UsedDim(), 1)
        bounds.SetLbound((0.0, 1.0, 1.9))
        self.assertEqual(bounds.UsedDim(), 2)
        bounds.SetUbound((0.1, 1.1, 2.0))
        self.assertEqual(bounds.UsedDim(), 3)
        ...
        self.assertRaises(AssertionError, bounds.SetLbound, (1.0, 1.0, 2.0, 3.0))
        self.assertRaises(AssertionError, bounds.SetUbound, (0.0,))
        self.assertRaises(AssertionError, bounds.SetUbound, (-1.0, 1.0, 2.0, 3.0))
