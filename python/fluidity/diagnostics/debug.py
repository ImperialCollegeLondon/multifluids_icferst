...
def dprint(msg, level=1, newline=True, flush=True):
    """
    Write a message to standard output if the supplied level is below or equal to
...
def deprint(msg, level=1, newline=True, flush=True):
    """
    Write a message to standard error if the supplied level is below or equal to
    the current debug level
    """
