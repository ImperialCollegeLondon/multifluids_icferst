...
!!$                ALLOCATE( MIDACV_SUB( CV_NONODS ))
  ...
  END SUBROUTINE INTENERGE_ASSEM_SOLVE
    ...
    subroutine VolumeFraction_Assemble_Solve( state,packed_state, storage_state, &
      ...
      ALLOCATE( DIAG_SCALE_PRES_COUP( 0,0,0 ), GAMMA_PRES_ABS( NPHASE,NPHASE,CV_NONODS ), GAMMA_PRES_ABS_NANO( NPHASE,NPHASE,CV_NONODS ), INV_B( 0,0,0 ) )
...
! got_free_surf - INDICATED IF WE HAVE A FREE SURFACE - TAKEN FROM DIAMOND EVENTUALLY...
        ...
        ALLOCATE(DIAG_SCALE_PRES_COUP(NPRES,NPRES,CV_NONODS),GAMMA_PRES_ABS(NPHASE,NPHASE,CV_NONODS),GAMMA_PRES_ABS_NANO(NPHASE,NPHASE,CV_NONODS),INV_B(NPHASE,NPHASE,CV_NONODS))
...
if (.false.) then
        ...
        IF ( .NOT.GLOBAL_SOLVE ) THEN
            ...
            if (GET_C_IN_CV_ADVDIF) then
                ...
                CALL COLOR_GET_CMC_PHA( CV_NONODS, U_NONODS, NDIM, NPHASE, NPRES, &
                NCOLC, FINDC, COLC, &
                PIVIT_MAT, &
        ...
        IF ( GLOBAL_SOLVE ) THEN
            ...
            P_ALL % val( 1, 1, : ) = UP( U_NONODS * NDIM * NPHASE + 1 : U_NONODS * NDIM * NPHASE + CV_NONODS )
...
!                        STRESS_IJ_ELE_EXT=0.0
                    ...
                    ELSE IF(GOT_DIFFUS) THEN If_GOT_DIFFUS2
                        ...
                        U_SNLOC, U_NLOC, CV_SNLOC, CV_NLOC, MAT_NLOC, NPHASE, &
                        SBUFEN_REVERSED,SBCVFEN_REVERSED,SBCVNGI, NDIM_VEL, NDIM, SLOC_UDIFFUSION, SLOC_UDIFFUSION_VOL, SLOC2_UDIFFUSION, SLOC2_UDIFFUSION_VOL, UDIFF_SUF_STAB, &
                        HDC, &
