    ...
    for i2 in range(N2 - 1):
        for i1 in range(N1 - 1):
            ...
            mesh.AddSurfaceElement(
                eles.Element(
                    nodes=[node1 - 1, node2 - 1, node3 - 1], ids=[boundarymarker]
                )
            )
            node4 = node1 + stride2
            mesh.AddSurfaceElement(
                eles.Element(
                    nodes=[node1 - 1, node4 - 1, node3 - 1], ids=[boundarymarker]
                )
            )
    ...
    for iy in range(Ny - 1):
        for iz in range(Nz - 1):
            ...
            mesh.AddVolumeElement(
                eles.Element(nodes=[node1, node4, node3, node7], ids=[region_id])
            )
            mesh.AddVolumeElement(
                eles.Element(nodes=[node1, node7, node8, node5], ids=[region_id])
            )
            mesh.AddVolumeElement(
                eles.Element(nodes=[node8, node3, node7, node1], ids=[region_id])
            )
            mesh.AddVolumeElement(
                eles.Element(nodes=[node1, node2, node4, node7], ids=[region_id])
            )
            mesh.AddVolumeElement(
                eles.Element(nodes=[node1, node7, node5, node6], ids=[region_id])
            )
            mesh.AddVolumeElement(
                eles.Element(nodes=[node1, node2, node7, node6], ids=[region_id])
            )
