...
if firstId is None:
    ...
    inputFilenames1 = [
        inputFilename1 + "_" + str(i) + ".vtu" for i in range(firstId, lastId + 1)
    ]
    if diffAgainstSingle:
        inputFilenames2 = [inputFilename2 for i in range(firstId, lastId + 1)]
    else:
        inputFilenames2 = [
            inputFilename2 + "_" + str(i) + ".vtu" for i in range(firstId, lastId + 1)
        ]

    outputFilenames = [
        outputFilename + "_" + str(i) + ".vtu" for i in range(firstId, lastId + 1)
    ]
